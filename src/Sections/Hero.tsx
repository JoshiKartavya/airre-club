...
const Hero = () => {
    return (
        <>
            <div  className="hero-main-back w-screen h-screen flex flex-col items-center justify-center bg-[var(--primary)] text-[var(--primary)]" style={{fontFamily: "michroma"}}>
                <div className="hero-inner h-[94%] w-[98%] bg-[var(--secondary)] rounded-2xl flex flex-col items-start  justify-end relative">
                    <Navbar textColor="var(--primary)" bgColor="var(--secondary)" />
